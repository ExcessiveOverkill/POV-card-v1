...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PA6     ------> SPI1_MISO
    */
    GPIO_InitStruct.Pin = ACCEL_MOSI_Pin|ACCEL_SCK_Pin|ACCEL_MISO_Pin;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA6     ------> SPI1_MISO
    */
    HAL_GPIO_DeInit(GPIOA, ACCEL_MOSI_Pin|ACCEL_SCK_Pin|ACCEL_MISO_Pin);
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB8     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOB, LED_DATA_Pin|LED_CLK_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PA3     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = LED_LATCH_Pin|LED_BLANK_Pin|DMA_TRIG_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
